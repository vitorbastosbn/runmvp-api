...
import com.runmvp.friendship.application.port.in.RejectFriendRequestUseCase;
...
@Service
public class RejectFriendRequestUseCaseImpl implements RejectFriendRequestUseCase {
    private final FriendshipRepository repo;

    public RejectFriendRequestUseCaseImpl(FriendshipRepository repo) { this.repo = repo; }

    @Override
    @Transactional
    public void execute(Long requestId, Long rejectorId) {
